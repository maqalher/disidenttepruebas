...
class T20_fm extends tt_module {
	function __construct($post) {
		//run the parrent constructor
		parent::__construct($post);
	}
...
class T20_f_6 extends tt_block {

	function __construct() {
		$this->block_id = 6;
		add_shortcode('tt_block6', array($this, 'render'));
	}
	...
	function render($atts) {
		...
		$buffy .= '<div class="b_block b_6 clearfix">';
