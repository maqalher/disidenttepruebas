<?php
class T20_b_2 extends tt_module {
	function __construct($post) {
		parent::__construct($post);
	}
	function render() {
		$buffy = '';
		$buffy .= '<div class="def_wgr introfx">';
		$buffy .= '<div class="item wgr T_post">';
		$buffy .= $this->get_image_wgr('blocktwo');
...
class T20_block_2 extends tt_block {
	function __construct() {
		$this->block_id = 2;
		add_shortcode('tt_block2', array($this, 'render'));
	}
	...
	function render($atts){
		...
		$buffy .= '<div class="b_block b_2 clearfix">';
		$buffy .= '<div class="b2_minus">';
