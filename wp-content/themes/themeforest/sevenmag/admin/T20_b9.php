<?php
class T20_b_9 extends tt_module {
	...
	function render() {
		...
		$buffy .= $this->get_image('slidehalf');
		$buffy .= $this->get_review();
		$buffy .= '</div>';
		$buffy .= $this->get_title();
		$buffy .= $this->get_excerpt();
		$buffy .= '</div>';
		return $buffy;
	}
}

class T20_block_9 extends tt_block {
	function __construct() {
		$this->block_id = 9;
		add_shortcode('tt_block9', array($this, 'render'));
	}
	...
	function render($atts){
		...
		$buffy .= '<div class="b_block b_9 clearfix">';
		$buffy .= '<div class="b9_minus">';
